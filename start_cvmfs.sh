...
mkdir -p /cvmfs/"${CVMFS_EXP}"-development.opensciencegrid.org
...
mount -t cvmfs "${CVMFS_EXP}"-development.opensciencegrid.org     /cvmfs/"${CVMFS_EXP}"-development.opensciencegrid.org
